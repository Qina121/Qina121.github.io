$(document).ready(function() {
  ...
  //调用函数
    ...
    // console.log($('.y-banner .content').height()) ;
    if($('.y-banner .content').height()<650){
      $('.y-banner .content .top').css({'background':'url(/images/banner_smallup.png) center no-repeat','height':'208px'});
      $('.y-banner .content .down').css({'background':'url(/images/banner_smalldown.png) center no-repeat','height':'137px'});
    }else{
      console.log(11111)
      $('.y-banner .content .top').css({'background':'url(/images/banner_up.png) center no-repeat','height':'270px'});
      $('.y-banner .content .down').css({'background':'url(/images/banner_down.png) center no-repeat','height':'170px'});
    }
  ...
  window.onresize=function(){
    ...
    if($('.y-banner .content').height()<650){
      $('.y-banner .content .top').css({'background':'url(/images/banner_smallup.png) center no-repeat','height':'208px'});
      $('.y-banner .content .bottom').css({'background':'url(/images/banner_smalldown.png) center no-repeat','height':'137px'});
    }else{
      console.log(11111)
      $('.y-banner .content .top').css({'background':'url(/images/banner_up.png) center no-repeat','height':'270px'});
      $('.y-banner .content .bottom').css({'background':'url(/images/banner_down.png) center no-repeat','height':'170px'});
    }
